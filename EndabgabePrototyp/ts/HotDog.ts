namespace EndabgabePrototyp {
    ...
    export class HotDog extends GameObject {
        ...
        public numberOfSauceLoadsOnTheHotDog: number = 0;
        ...
        public updateHotDog(_walls: f.Node): void {
            ...
            if (this.numberOfSauceLoadsOnTheHotDog >= currentDifficultyValues.numberOfNeededSauce) {
        ...
        public moveHotDog(_direction: number, _walls: f.Node): void {
